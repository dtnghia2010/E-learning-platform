...
export default  function Register(){
    ...
    return (
        ...
        <div>
       <div className="flex items-center justify-center  w-full h-screen  bg-myWhite">
        <div className="bg-myLightYellow  rounded-lg  px-4 py-10 max-w-sm mx-auto w-full h-screen ">
            ...
            <form >
                <div className="mb-6">
                    ...
                    <input
                        ...
                        id="email"
                        value={email}
                        className="w-full px-3 py-2 rounded-lg bg-[#ffffff] border focus:outline-none focus:ring-indigo-500 focus:ring-1"
