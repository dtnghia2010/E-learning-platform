...
const Profile = () => {
    ...
    return (
        <div>
            <div className=" flex justify-around w-full bg-blue-light  items-center p-8">
            ...
            <div className="  flex-col items-center justify-center w-full bg-myBeige p-6">
                <div className="mb-4 flex-col-reverse justify-center items-center ">
                    <div className="space-y-1">
                        <h2 className="text-2xl font-bold mb-1">Documents of taylor123</h2>
